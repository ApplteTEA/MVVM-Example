 ...
 */
public abstract class Hilt_MainActivity<B extends ViewDataBinding, VM extends ViewModel> extends BaseActivity<B, VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainActivity(int layoutResId) {
    super(layoutResId);
    _initHiltInternal();
  }
